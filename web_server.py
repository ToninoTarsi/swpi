...
#_enabled_path = ("/reset_camera.py","/","/index.html","/login.py","/swpi_webconfig.py","/swpi-banner.jpg","/log/","/db/","/download_cfg.py","/upload_cfg.py","/upload_cfg.html","/web_reboot.py","/web_status.py","/web_swpi_update.py","/favicon.ico")
