...
"""This module defines the WH1080_RTL-SDR sensor."""
...
class Sensor_WH1080RTLSDR(sensor.Sensor):
	...
	def GetData(self):
		...
		while ( not good_data ):
			...
			if ( station_id != "None" and station_id != "Time"):
				...
				log("Datetime data received from WH1080_RTL-SDR. Waiting for weather data...")
				time.sleep(48)
			else:
				log("Bad data received from WH1080_RTL-SDR")
				time.sleep(48)
		log("First data received from WH1080_RTL-SDR, station %s. Processing..." % station_id)
